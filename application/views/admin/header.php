        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="">
                        <a href="<?=base_url('admin/manage_services');?>">
                            <i class="fa fa-edit"></i> <span>Kelola Layanan</span>
                        </a>
                    </li>
                    <li class="">
                    ...
                    <li class="">
                        <a href="<?=base_url('admin/manage_info');?>">
                            <i class="fa fa-info-circle"></i> <span>Kelola Informasi</span>
                        </a>
                    </li>
            </section>
            <!-- /.sidebar -->
