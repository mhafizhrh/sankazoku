            ...
            <div class="login-box-body">
                ...
                <form method="post">
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" name="full_name" value="<?=$full_name?>" placeholder="Nama Lengkap" maxlength="100" autofocus>
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" name="username" value="<?=$username?>" placeholder="Nama Pengguna" maxlength="100">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                    ...
                    <div class="form-group has-feedback">
                        <input type="password" class="form-control" name="password_verify" placeholder="Konfirmasi Kata Sandi">
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-block btn-flat" name="register_btn">Daftar</button>
                    </div>
                </form>
                <hr>
                <div class="form-group">
                	<a class="btn btn-default btn-flat btn-block" href="<?=base_url('auth/login')?>">MASUK</a>
